...
if (NOT CLONE_SHARED_REPOSITORIES)
	...
	AddTripleConfigureEnv("AR" "ar")
	AddTripleConfigureEnv("NM" "nm")
	AddTripleConfigureEnv("OBJDUMP" "objdump")
	AddTripleConfigureEnv("RANLIB" "ranlib")
	AddTripleConfigureEnv("STRIP" "strip")
