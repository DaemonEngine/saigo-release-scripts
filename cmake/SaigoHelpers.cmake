...
macro(addCCompilerFlags NAME)
	foreach(FLAG IN LISTS ARGN)
		string(TOUPPER "${FLAG}" FLAG_SLUG)
		string(REPLACE "^-" "" "${FLAG_SLUG}" FLAG_SLUG)
		string(REPLACE "[^A-Z0-9]" "_" "${FLAG_SLUG}" FLAG_SLUG)
		set(FLAG_SLUG "FLAG_${FLAG_SLUG}")
		check_C_compiler_flag("C" "${FLAG}" ${FLAG_SLUG})
		if (${${FLAG_SLUG}})
